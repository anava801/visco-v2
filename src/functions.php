...
function casestudies_post_type() {
	$labels = array(
		'name'                  => _x( 'Case Studies', 'Case Studies General Name' ),
		'singular_name'         => _x( 'Case Studies', 'Case Studies Singular Name' ),
		'menu_name'             => __( 'Case Studies' ),
		'name_admin_bar'        => __( 'Case Studies' ),
		'attributes'            => __( 'Case Studies Attributes' ),
		...
		'insert_into_item'      => __( 'Insert into Case Studies' ),
		'uploaded_to_this_item' => __( 'Uploaded to this Case Studies' ),
...
//include_once __DIR__ . '/acf-featured-project/init.php';