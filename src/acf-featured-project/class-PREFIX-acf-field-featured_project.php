 ...
 */
class PREFIX_acf_field_featured_project extends \acf_field {
	/**
	...
	public function __construct() {
		 ...
		 */
		$this->label = __( 'Featured Project', 'TEXTDOMAIN' );
		...
		$this->env = array(
			'url'     => site_url( str_replace( ABSPATH, '', __DIR__ ) ), // URL to the acf-featured_project directory.
	...
	public function render_field_settings( $field ) {
		...
		while( have_rows('case_studies', $page->ID) ) : the_row();
	...
	public function input_admin_enqueue_scripts() {
		...
		wp_enqueue_script( 'PREFIX-featured_project' );
		wp_enqueue_style( 'PREFIX-featured_project' );
	}
}
